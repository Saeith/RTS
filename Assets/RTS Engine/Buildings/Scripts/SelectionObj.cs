...
namespace RTSEngine
{
	public class SelectionObj : MonoBehaviour {
        ...
        void OnTriggerEnter (Collider other)
        {
            ...
            if(other.gameObject.GetComponent<SelectionObj>())
            {
                //trigger custom event for selection obj collision:
                if(GameManager.Instance.Events != null)
                    GameManager.Instance.Events.OnSelectionObjEnter(this, other.gameObject.GetComponent<SelectionObj>());
            }
        }
